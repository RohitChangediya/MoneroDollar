...
The first audit was generously funded by [Arweave](https://www.arweave.org/), one of the early adopters of RandomX. The remaining three audits were funded by donations from the [Monero community](https://ccs.getmonerodollar.org/proposals/RandomX-audit.html). All four audits were coordinated by [OSTIF](https://ostif.org/).
...
RandomX was primarily designed as a PoW algorithm for [Monero](https://www.getmonerodollar.org/). The recommended usage is following:
