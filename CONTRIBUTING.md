...
posted to #monerodollar-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The MoneroDollar Project.
...
The "MoneroDollar Maintainer Team" is defined in this document as the following users:
- fluffypony
- monerodollarmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to MoneroDollar code or MoneroDollar's dependency code or MoneroDollar's potential/future dependency code or research which successfully implements MoneroDollar.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the MoneroDollar Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the MoneroDollar Maintainer Team.
